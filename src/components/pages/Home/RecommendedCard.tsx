...
export default function RecommendedCard({ blog }: RecommendedCardProps) {
  return (
    <Link
      ...
      className="block w-full z-10 border border-gray-200 p-2 rounded-lg shadow-md cursor-pointer hover:shadow-lg transition duration-200 hover:border-gray-300 relative group rounded-md"
    >
      {/* Blog Image */}
